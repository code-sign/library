...
},{"process":94}],70:[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{"./TweenLite.js":70}],74:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70}],76:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70}],78:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70}],80:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70}],82:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70}],84:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70,"./TimelineLite.js":82}],86:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70}],88:[function(require,module,exports) {
"use strict";
...
exports.Power3 = _TweenLite.Power3;
exports.Power4 = _TweenLite.Power4;
},{"./TweenLite.js":70}],66:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":70,"./TweenMaxBase.js":72,"./CSSPlugin.js":74,"./AttrPlugin.js":76,"./RoundPropsPlugin.js":78,"./DirectionalRotationPlugin.js":80,"./TimelineLite.js":82,"./TimelineMax.js":84,"./BezierPlugin.js":86,"./EasePack.js":88}],90:[function(require,module,exports) {
'use strict';
...
},{"ssr-window":90}],62:[function(require,module,exports) {
'use strict';
...
const Virtual = {
  ...
  renderSlide(slide, index$$1) {
    ...
    const $slideEl = params.renderSlide ? (0, _dom.$)(params.renderSlide.call(swiper, slide, index$$1)) : (0, _dom.$)(`<div class="${swiper.params.slideClass}" data-swiper-slide-index="${index$$1}">${slide}</div>`);
  ...
  init() {
    ...
    if (params.clickable) {
      $el.on('click', `.${params.bulletClass}`, function onClick(e) {
        e.preventDefault();
        let index$$1 = (0, _dom.$)(this).index() * swiper.params.slidesPerGroup;
...
const Parallax = {
  ...
  setTranslate() {
    ...
    slides.each((slideIndex, slideEl) => {
      ...
      (0, _dom.$)(slideEl).find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each((index$$1, el) => {
  ...
  load() {
    ...
    if (swiper.params.watchSlidesVisibility) {
      $wrapperEl.children(`.${swiperParams.slideVisibleClass}`).each((elIndex, slideEl) => {
        const index$$1 = isVirtual ? (0, _dom.$)(slideEl).attr('data-swiper-slide-index') : (0, _dom.$)(slideEl).index();
...
const History = {
  ...
  setHistory(key, index$$1) {
    ...
    if (swiper.params.history.replaceState) {
      _ssrWindow.window.history.replaceState({ value }, null, value);
    } else {
      _ssrWindow.window.history.pushState({ value }, null, value);
    }
  },
  slugify(text$$1) {
...
},{"dom7/dist/dom7.modular":92,"ssr-window":90}],95:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":95}],106:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":68}],60:[function(require,module,exports) {
  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      css: '\
        ...
        .audiojs { font-family: monospace; font-size: 12px; \
          -webkit-box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); -moz-box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); \
          -o-box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); } \
        .audiojs .play-pause { margin: 0px; overflow: hidden; } \
        .audiojs p { display: none; width: 25px; height: 40px; margin: 0px; cursor: pointer; } \
        .audiojs .play { display: block; } \
        .audiojs .scrubber { position: relative;width: 280px; background: #5a5a5a; border-top: 1px solid #3f3f3f; border-left: 0px; border-bottom: 0px; overflow: hidden; } \
        ...
        .audiojs .time {color: #ddd; text-shadow: 1px 1px 0px rgba(0, 0, 0, 0.5); } \
      ...
      play: function play() {
        ...
        //music tag add
        $('.micro').remove();
        $('li.playing').append(' <div class="micro music">\
                    <a href="#none">\
                        <span class="one"></span>\
                        <span class="two"></span>\
      ...
      updatePlayhead: function updatePlayhead(percent) {
        ...
        // range songs custom
        var range = $('.range');
        range.find('input').val(100 * percent);
    ...
    attachEvents: function attachEvents(wrapper, audio) {
      ...
      range.find('input').on('input', function () {
        var skipVal = $(this).val() / 100;
        audio.skipTo(skipVal);
      });
...
module.exports="/bensound-dubstep.3a4fac7a.mp3";
},{}],46:[function(require,module,exports) {
module.exports="/bensound-cute.0682003a.mp3";
},{}],48:[function(require,module,exports) {
module.exports="/bensound-buddy.ebfc2c4a.mp3";
},{}],50:[function(require,module,exports) {
module.exports="/bensound-acousticbreeze.a593f572.mp3";
},{}],52:[function(require,module,exports) {
module.exports="/bensound-epic.909bb5e3.mp3";
},{}],54:[function(require,module,exports) {
module.exports="/bensound-funnysong.cedf73ee.mp3";
},{}],56:[function(require,module,exports) {
module.exports="/bensound-littleidea.8c705f95.mp3";
},{}],58:[function(require,module,exports) {
module.exports="/bensound-betterdays.eb483f3f.mp3";
...
var _audio = require('../audiojs/audio');

var _bensoundDubstep = require('../mp3/bensound-dubstep.mp3');

var _bensoundDubstep2 = _interopRequireDefault(_bensoundDubstep);

var _bensoundCute = require('../mp3/bensound-cute.mp3');

var _bensoundCute2 = _interopRequireDefault(_bensoundCute);

var _bensoundBuddy = require('../mp3/bensound-buddy.mp3');

var _bensoundBuddy2 = _interopRequireDefault(_bensoundBuddy);

var _bensoundAcousticbreeze = require('../mp3/bensound-acousticbreeze.mp3');

var _bensoundAcousticbreeze2 = _interopRequireDefault(_bensoundAcousticbreeze);

var _bensoundEpic = require('../mp3/bensound-epic.mp3');

var _bensoundEpic2 = _interopRequireDefault(_bensoundEpic);

var _bensoundFunnysong = require('../mp3/bensound-funnysong.mp3');

var _bensoundFunnysong2 = _interopRequireDefault(_bensoundFunnysong);

var _bensoundLittleidea = require('../mp3/bensound-littleidea.mp3');

var _bensoundLittleidea2 = _interopRequireDefault(_bensoundLittleidea);

var _bensoundBetterdays = require('../mp3/bensound-betterdays.mp3');

var _bensoundBetterdays2 = _interopRequireDefault(_bensoundBetterdays);
...
(0, _jquery2.default)(function () {
    ...
    var musicList = [_bensoundDubstep2.default, _bensoundCute2.default, _bensoundBuddy2.default, _bensoundAcousticbreeze2.default, _bensoundEpic2.default, _bensoundFunnysong2.default, _bensoundLittleidea2.default, _bensoundBetterdays2.default, _bensoundDubstep2.default, _bensoundCute2.default, _bensoundBuddy2.default, _bensoundAcousticbreeze2.default, _bensoundEpic2.default, _bensoundFunnysong2.default, _bensoundLittleidea2.default, _bensoundBetterdays2.default];

    // console.log(musicList[0],'zz');


    // Setup the player to autoplay the next track
    var a = _audio.audiojs.createAll({
        trackEnded: function trackEnded() {
            var next = (0, _jquery2.default)('ol li.playing').next();
            if (!next.length) next = (0, _jquery2.default)('ol li').first();
            next.addClass('playing').siblings().removeClass('playing');
            // audio.load($('a', next).attr('data-src'));

            var nextIdx = next.index();
            audio.load(musicList[nextIdx]);
            audio.play();
    ...
    var audio = a[0];
    var first = (0, _jquery2.default)('ol a').attr('data-src');
    var first = musicList[0];
    (0, _jquery2.default)('ol li').first().addClass('playing');
    audio.load(first);

    // Load in a track on click
    (0, _jquery2.default)('ol li').click(function (e) {
        e.preventDefault();
        (0, _jquery2.default)(this).addClass('playing').siblings().removeClass('playing');

        var musicIdx = (0, _jquery2.default)(this).index();
        audio.load(musicList[musicIdx]);

        audio.play();
        (0, _jquery2.default)('#btn_playpause').removeClass('off').find('i').text('stop_arrow');

        var thisAlbum = (0, _jquery2.default)(this).find('.profile img').attr('src');

        // $('.play_info').css('background','#fff');
        (0, _jquery2.default)('.play_info .bg').css('background-image', 'url(' + thisAlbum + '');
    });
    // Keyboard shortcuts
    (0, _jquery2.default)(document).keydown(function (e) {
        ...
        // right arrow
        if (unicode == 39) {
            var next = (0, _jquery2.default)('li.playing').next();
            if (!next.length) next = (0, _jquery2.default)('ol li').first();
            next.click();
            // back arrow
        } else if (unicode == 37) {
            var prev = (0, _jquery2.default)('li.playing').prev();
            if (!prev.length) prev = (0, _jquery2.default)('ol li').last();
            prev.click();
            // spacebar
        } else if (unicode == 32) {
            audio.playPause();
    ...
    //btn event
    (0, _jquery2.default)('.btn_area > a').on('click', function () {
        (0, _jquery2.default)('.btn_area > a').removeClass('on');
        (0, _jquery2.default)('.micro.music').hide();
        (0, _jquery2.default)(this).addClass('on');
    });

    (0, _jquery2.default)('#btn_playpause').on('click', function () {
        audio.playPause();
        if ((0, _jquery2.default)(this).hasClass('off')) {
            (0, _jquery2.default)(this).removeClass('off');
            (0, _jquery2.default)(this).find('i').text('stop_arrow');
        } else {
            (0, _jquery2.default)(this).addClass('off');
            (0, _jquery2.default)(this).find('i').text('play_arrow');
        }
        return false;
    });

    (0, _jquery2.default)('#btn_prev').on('click', function () {
        var prev = (0, _jquery2.default)('li.playing').prev();
        if (!prev.length) prev = (0, _jquery2.default)('ol li').last();
        prev.click();
        return false;
    ...
    (0, _jquery2.default)('#btn_next').on('click', function () {
        var next = (0, _jquery2.default)('li.playing').next();
        if (!next.length) next = (0, _jquery2.default)('ol li').first();
        next.click();
        return false;
    ...
    (0, _jquery2.default)('ol > li').on('click', function () {
        nowPlayTitle();
    });

    //now playing title
    function nowPlayTitle() {
        var onM = (0, _jquery2.default)('.playing');
        var onM_tit = onM.find('a').text();
        console.log(onM_tit);
        (0, _jquery2.default)('.now_playing').text(onM_tit);
    }nowPlayTitle();
});

//music 
setInterval(function () {
    (0, _jquery2.default)('.music').find('span').each(function () {
        var ranN = Math.floor(Math.random(0) * 10);
        //console.log(ranN);
        (0, _jquery2.default)(this).css({ 'height': 4 * ranN + 'px' });
    });
}, 130);

//fixmenu
(0, _jquery2.default)('.fixmenu .arrow').on('click', function () {

    if ((0, _jquery2.default)(this).hasClass('on')) {
        (0, _jquery2.default)(this).removeClass('on').find('i').html('keyboard_arrow_up');
        (0, _jquery2.default)('.play_info').animate({ height: '80px' });
    } else {
        (0, _jquery2.default)(this).addClass('on').find('i').html('keyboard_arrow_down');
        (0, _jquery2.default)('.play_info').animate({ height: '300px' });
    }
});
},{"jquery":64,"gsap/TweenMax":66,"swiper":62,"../style.scss":106,"../audiojs/audio":60,"../mp3/bensound-dubstep.mp3":44,"../mp3/bensound-cute.mp3":46,"../mp3/bensound-buddy.mp3":48,"../mp3/bensound-acousticbreeze.mp3":50,"../mp3/bensound-epic.mp3":52,"../mp3/bensound-funnysong.mp3":54,"../mp3/bensound-littleidea.mp3":56,"../mp3/bensound-betterdays.mp3":58}],105:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/js.1206f0eb.map