...
(0, _jquery.default)('.select').each(function () {
  var select = (0, _jquery.default)('.select');
  var options = (0, _jquery.default)('.option');
  var selectDefault = select.find('.default');
  var thisSelect = (0, _jquery.default)(this);
  var thisSltDefault = thisSelect.find('.default');
  var optionGroup = thisSelect.find('.option');
  var optionItem = optionGroup.find('li > a');
  thisSltDefault.on('click', function () {
    (0, _jquery.default)(this).toggleClass('on').next('ul').toggle();
  });
  optionItem.on('click', function () {
    var selectedText = (0, _jquery.default)(this).text();
    initSelect();
    thisSltDefault.text(selectedText);
  });
  (0, _jquery.default)('html').on('click', function (e) {
    if (!(0, _jquery.default)(e.target).parents().hasClass('select')) {
      initSelect();
    }
  });
...
},{"../style.scss":"style.scss","jquery":"node_modules/jquery/dist/jquery.js","gsap/TweenMax":"node_modules/gsap/TweenMax.js"}],"C:/Users/shkim/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
