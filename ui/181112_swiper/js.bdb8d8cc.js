...
},{"./bundle-url":48}],6:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"./../node_modules/swiper/dist/css/swiper.min.css":[["swiper.min.9e664cc6.css",44],"swiper.min.9e664cc6.js","swiper.min.9e664cc6.map",44],"_css_loader":46}],42:[function(require,module,exports) {
...
},{"process":42}],17:[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{"./TweenLite.js":17}],21:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17}],23:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17}],25:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17}],27:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17}],29:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17}],31:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17,"./TimelineLite.js":29}],33:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17}],35:[function(require,module,exports) {
"use strict";
...
exports.Power3 = _TweenLite.Power3;
exports.Power4 = _TweenLite.Power4;
},{"./TweenLite.js":17}],14:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":17,"./TweenMaxBase.js":19,"./CSSPlugin.js":21,"./AttrPlugin.js":23,"./RoundPropsPlugin.js":25,"./DirectionalRotationPlugin.js":27,"./TimelineLite.js":29,"./TimelineMax.js":31,"./BezierPlugin.js":33,"./EasePack.js":35}],38:[function(require,module,exports) {
'use strict';
...
},{"ssr-window":38}],12:[function(require,module,exports) {
'use strict';
...
},{"dom7/dist/dom7.modular":40,"ssr-window":38}],8:[function(require,module,exports) {
'use strict';
...
var swiperSlide = function swiperSlide() {
    ...
    var mySwiper = new _swiper2.default('.swiper-container.basic', {
        pagination: {
    ...
    var mySwiperMulti = new _swiper2.default('.swiper-container.multi', {
        pagination: {
            el: '.multi .swiper-pagination',
            clickable: true
        },
        navigation: {
    ...
    var mySwiperFree = new _swiper2.default('.swiper-container.free', {
        navigation: {
            nextEl: '.free .swiper-button-next',
            prevEl: '.free .swiper-button-prev'
        },
        slidesPerView: 3.3,
        spaceBetween: 20,
        loop: true,
    ...
    var mySwiperCircle = new _swiper2.default('.swiper-container.circle', {
        // loop: true,
        slidesPerView: 5,
        freeMode: true,
        speed: 300,
        on: {
            progress: function progress(_progress) {
                ...
                //if loop progress set
                // if(progress < 0.1 || progress ==1){
                //     progress = 0;
                // }

                var move = 2.3;
                var circleBoard = $('.circle_wrap .board');
                var circleItem = $('.circle_wrap .c_item');

                circleBoard.css({
                    transform: 'rotate(' + -_progress * (720 / move) + 'deg)'
                });
                circleItem.css({
                    transform: 'rotate(' + _progress * (720 / move) + 'deg)'
                });
    ...
    // not use spaceBetween  
    var gutter = 20;
    var slideAmount = 10; // slideAmount

    var mySwiperTab = new _swiper2.default('.swiper-container.tabslide', {
        navigation: {
    ...
    var mySwiperTabGroup = new _swiper2.default('.tabslide_group .swiper-container.tabslide', {
        navigation: {
            nextEl: '.tabslide_group .tabslide .swiper-button-next'
        },
        slidesPerView: 'auto',
        freeMode: true
    });

    var mySwiperCont = new _swiper2.default('.swiper-container.tabcont', {
        on: {
            slideChange: function slideChange() {
                $('.tabslide_group .tabslide a').removeClass('on');
                $('.tabslide_group .tabslide .swiper-slide').eq(mySwiperCont.activeIndex).find('a').addClass('on');

                // tabNavSwiper Auto Move
                if (mySwiperCont.previousIndex < mySwiperCont.activeIndex) {
                    mySwiperTabGroup.slideTo(mySwiperCont.activeIndex - 2);
                } else {
                    mySwiperTabGroup.slideTo(mySwiperCont.activeIndex - 1);
                }

                var line = $('.tabslide_group').find('.active_line');
                var activeTab = $('.tabslide_group .tabslide').find('a.on').parent('.swiper-slide');

                var tabWid = Math.floor(activeTab.innerWidth());
                var tabXpos = Math.floor(activeTab.position().left);
                ...
                // first tab prevent progress transform
                if (mySwiperCont.activeIndex == 0) {
                    line.css({
            ...
            progress: function progress(_progress2) {
                ...
                var slideProgress = _progress2 % slideFullProgress / slideFullProgress; // slideProgress[0,1]

                var line = $('.tabslide_group').find('.active_line');

                var scaleX = 1 + slideProgress;
                var scaleXLeft = 1 + (slideProgress - 0.5);

                if (_progress2 > 0 && _progress2 <= 1) {
                    if (slideProgress <= 0.5) {
                        ...
                        line.css({
                            'transform': 'scaleX(' + scaleXLeft + ') translateX(' + -20 * scaleXLeft + 'px)'
                        });
                    }
                }
            }
    ...
    $('.tabslide').each(function () {
        var _this = $(this);
        var tabs = _this.find('a');
        var line = _this.find('.active_line');
        var tabWid = '';
        var tabXpos = '';
        var activeTab = _this.find('a.on').parent('.swiper-slide');

        // init line
        line.css({
            width: _this.find('.swiper-slide').eq(0).innerWidth(),
            left: gutter
        });

        tabs.on('click', function () {

            activeTab = $(this).parent('.swiper-slide');

            tabs.removeClass('on');
            $(this).addClass('on');

            tabWid = Math.floor(activeTab.innerWidth());
            tabXpos = Math.floor(activeTab.position().left);

            // tab move
            var tabIdx = activeTab.index();
            // mySwiperTab.slideTo(tabIdx);
            // 각각 동작하도록 분리시켜야함
        ...
        // flex mode center reposition
        $(window).on('resize', function () {
            if ($('.tabslide').hasClass('flex')) {

                if (_this.parents().hasClass('tabslide_group')) {
                    activeTab = $('.tabslide_group .tabslide').find('a.on').parent('.swiper-slide');
                }
    ...
    // tabslide group
    $('.tabslide_group').each(function () {
        var _this = $(this);
        var tabs = _this.find('.tabslide a');

        tabs.on('click', function () {
            // tab move
            var activeTab = $(this).parent('.swiper-slide');
            var tabIdx = activeTab.index();
            mySwiperCont.slideTo(tabIdx);
        });
    });
}; /****************************/
/* swiper                   */
...
},{"swiper":12}],4:[function(require,module,exports) {
'use strict';
...
var _swiperSlide = require('./swiperSlide');
...
(0, _swiperSlide2.default)();
},{"../scss/main.scss":6,"jquery":10,"gsap/TweenMax":14,"swiper":12,"./swiperSlide":8}],56:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/js.bdb8d8cc.map