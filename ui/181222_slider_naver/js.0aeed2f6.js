...
},{"process":45}],16:[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{"./TweenLite.js":16}],20:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16}],22:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16}],24:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16}],26:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16}],28:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16}],30:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16,"./TimelineLite.js":28}],32:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16}],34:[function(require,module,exports) {
"use strict";
...
exports.Power3 = _TweenLite.Power3;
exports.Power4 = _TweenLite.Power4;
},{"./TweenLite.js":16}],14:[function(require,module,exports) {
"use strict";
...
},{"./TweenLite.js":16,"./TweenMaxBase.js":18,"./CSSPlugin.js":20,"./AttrPlugin.js":22,"./RoundPropsPlugin.js":24,"./DirectionalRotationPlugin.js":26,"./TimelineLite.js":28,"./TimelineMax.js":30,"./BezierPlugin.js":32,"./EasePack.js":34}],39:[function(require,module,exports) {
'use strict';
...
},{"ssr-window":39}],10:[function(require,module,exports) {
'use strict';
...
},{"dom7/dist/dom7.modular":41,"ssr-window":39}],47:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":47}],37:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":43}],8:[function(require,module,exports) {
'use strict';
...
var swiperSlide = function swiperSlide() {
    ...
    var swiper = new _swiper2.default('.swiper-container.basic', {
        pagination: {
    ...
    var swiperMulti = new _swiper2.default('.swiper-container.multi', {
        pagination: {
    ...
    var swiperFree = new _swiper2.default('.swiper-container.free', {
        navigation: {
    ...
    var swiperTab = new _swiper2.default('.tabslide', {
        navigation: {
    ...
    $('.tabslide').each(function () {
        ...
        $(window).on('resize', function () {
            if (_this.hasClass('flex')) {
                ...
                //resize line move error prevent
                if (_this.parents().hasClass('tabslide_group')) {
                    activeTab = _this.parents('.tabslide_group').find('.tabslide a.on').parent('.swiper-slide');
                }
    ...
    // tabslide group
    var colors = ['lightsteelblue', 'royalblue', 'MediumPurple', 'gray', 'LightCoral', 'gold', 'lightsalmon', 'SlateGrey', 'BurlyWood', 'green'];
    ...
    $('.tabslide_group').each(function () {
        ...
        var swiperTabGroup = new _swiper2.default(_this.find('.tabslide'), {
            navigation: {
                nextEl: _this.find('.tabslide .swiper-button-next')
            },
            slidesPerView: 'auto',
            freeMode: true
        });

        var swiperCont = new _swiper2.default(_this.find('.tabcont'), {
            on: {
                slideChange: function slideChange() {
                    _this.find('.tabslide a').removeClass('on');
                    _this.find('.tabslide .swiper-slide').eq(swiperCont.activeIndex).find('a').addClass('on');

                    // tabNavSwiper Auto Move
                    if (swiperCont.previousIndex < swiperCont.activeIndex) {
                        swiperTabGroup.slideTo(swiperCont.activeIndex - 2);
                    } else {
                        swiperTabGroup.slideTo(swiperCont.activeIndex - 1);
                    }

                    var line = _this.find('.active_line');
                    var activeTab = _this.find('.tabslide').find('a.on').parent('.swiper-slide');
                    ...
                    // color change tab
                    if (_this.find('.tabslide').hasClass('color')) {
                        _this.find('.active_line').css({
                            backgroundColor: colors[swiperCont.activeIndex]
                        });
                        _this.find('.swiper-slide').find('a').css({
                            color: 'inherit'
                        });
                        _this.find('.swiper-slide').eq(swiperCont.activeIndex).find('a').css({
                            color: colors[swiperCont.activeIndex]
                        });
                    }
                },
                progress: function progress(_progress) {
                    var slideFullProgress = 1 / (slideAmount - 1); // slideFullProgress
                    var slideProgress = _progress % slideFullProgress / slideFullProgress; // slideProgress[0,1]
        ...
        tabs.on('click', function () {
            ...
            var tabIdx = activeTab.index();
            swiperCont.slideTo(tabIdx);
        });
    });
};

exports.default = swiperSlide;
},{"swiper":10,"../node_modules/swiper/dist/css/swiper.min.css":37}],6:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":43}],4:[function(require,module,exports) {
'use strict';
...
},{"jquery":12,"gsap/TweenMax":14,"swiper":10,"./swiperSlide":8,"../scss/main.scss":6}],49:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/js.0aeed2f6.map